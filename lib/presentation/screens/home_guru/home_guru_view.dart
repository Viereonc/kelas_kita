        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: Color(0xFFF8F4F3),
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Jadwal Mengajar Hari Ini", style: tsSubHeader3(screenSize: screenWidth, fontWeight: FontWeight.bold)),
                    Expanded(
                      child: Obx(() => homeController.isLoading.value ? ShimmerLoadingListView(
                        screenWidth: screenWidth,
                        screenHeight: screenHeight,
                      ) : ListView.builder(
                        itemCount: 9,

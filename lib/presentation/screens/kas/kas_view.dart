    ...
    return Scaffold(
        ...
        body: Obx(() {
          if (kasController.isLoading.value) {
            ...
            return Padding(
              padding: EdgeInsets.only(left: screenWidth * 0.05, right: screenWidth * 0.05, bottom: 15),
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      margin: EdgeInsets.only(bottom: screenHeight * 0.015, top: screenHeight * 0.03),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                        month,
                                        style: tsParagraft4(fontWeight: FontWeight.w600, screenSize: screenWidth * 0.9,)
                                    ),
                                  ),
                                ),
                                Container(
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    payment,
                                                    style: tsParagraft4(fontWeight: FontWeight.w500, screenSize: screenWidth * 0.8,).copyWith(color: Colors.grey.withOpacity(0.9)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                            Text(
                                              "Rp10.000", style: tsParagraft3(fontWeight: FontWeight.w600, screenSize: screenWidth * 0.9,).copyWith(color: Color(0xFF34A853)),
                                            )
                                          ],
                                        ),
                                      );

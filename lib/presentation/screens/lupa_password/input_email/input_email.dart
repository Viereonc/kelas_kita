            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Masukan Email', style: tsParagraft3(screenSize: screenWidth * 0.85, color: Colors.grey.withOpacity(0.8)),),
                ],
              ),
            ),
            Center(
              child: Container(
                ...
                child: Image.asset('lib/assets/images/vector_iphone_locked.png'),
              ),
            ),
            Container(

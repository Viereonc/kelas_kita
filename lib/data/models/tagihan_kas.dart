...
class Jumlah {
  ...
  factory Jumlah.fromJson(Map<String, dynamic> json) {
    // // Check if nominal is a String and convert to int
    // int parsedNominal;
    // if (json["nominal"] is String) {
    //   parsedNominal = int.tryParse(json["nominal"]) ?? 0; // default to 0 if parsing fails
    // } else {
    //   parsedNominal = json["nominal"];
    // }
